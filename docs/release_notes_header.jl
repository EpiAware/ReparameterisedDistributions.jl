...
ReparameterisedDistributions.jl follows a hybrid changelog approach:
...
See [GitHub Releases](https://github.com/EpiAware/ReparameterisedDistributions.jl/releases) for minor/patch
release information.
